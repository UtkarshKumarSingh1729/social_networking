    ...
    <div class="col-sm-8">
        <form action="" method="post" enctype="multipath/form-data">
            ...
            <tr>
                ...
                <td>
                    <input class="form-control" type="text" name="user_gender" required value="<?php echo$user_gender;?>">
                </td>
            </tr>
            <tr>
                <td style="font-weight:bold;">
                ...
                <td>
                    <input class="form-control" type="text" name="discribe_user" required value="<?php echo$describe_user;?>">
                </td>
            </tr>
            <tr>
                <td style="font-weight:bold;">
            ...
            <tr>
                ...
                <td>
                    <input class="form-control input-md" type="text" name="u_birthday" required value="<?php echo$user_birthday;?>">
                </td>
            </tr>
            ...
            <tr>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        <form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id="f">
                                            ...
                                            <textarea class="form-control" name="content" placeholder="Someone" id="" cols="83" rows="4"></textarea><br>
                                            <input type="submit" name="sub" value="Submit" class="btn btn-default"><br><br>
                                            <pre>Answer the above quetion we will ask this quetion if you forgot your <br> PASSWORD.</pre>
                                            <br><br>
                                        </form>
                                        <?php
                                            if(isset($_POST['sub'])){
                                                ...
                                                if($bfn==''){
                                                    ...
                                                    echo"<script>window.open('edit_profile.php?u_id$user_id','_self')</script>";
                                                        ...
                                                        echo"<script>alert('Error While Upadating')</script>";
                                                    echo"<script>window.open('edit_profile.php?u_id='$user_id','_self')</script>";
                ...
                <tr align="center">
                    <td colspan="6">
                        <input type="submit" clss="btn btn-info" name="update" style="width:250px;" value="Update">
                    </td>
...
if(isset($_POST['update'])){
    ...
    $describe_user=htmlentities($_POST['discribe_user']);
    ...
    user_pass='$u_pass', user_email='$u_email',user_birthday='$u_birthday',user_gender='$u_gender' where user_id='$user_id'";
    $run=mysqli_query($con,$update);
    if($run){

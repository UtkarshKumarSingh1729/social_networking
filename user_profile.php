    ...
    <?php
        ...
        <center>
            <div class='col-sm-3' style='background-color:#e6e6e6;'>
                ...
                <img class='img-circle' src='users/$image' width='150px' hight='150px'>
                <br><br>
                <ul class='list-group'>
            ...
            if($user_id == $userown_id){
                echo"<a href='edit_profile.php?u_id=$userown_id' class='btn btn-success'/>Edit Profile</a><br><br><br>0";
            }

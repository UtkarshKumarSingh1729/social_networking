...
<div class="row">
    ...
    <?php
        ...
        while($row_user=mysqli_fetch_array($run_user)){
            ...
            if($row_user['user_id']==$user_from_msg){
                continue;
            }
            echo"
        ...
        <div class="load_msg" id="scroll_messages">
            <?php
                ...
                while($row_msg=mysqli_fetch_array($run_msg)){
                    ...
                    ?>
                    <div id="loaded_msg">
                        <p><?php if($user_to ==$user_to_msg AND $user_from==$user_from_msg){echo "<div class='message' id='green' data-toggle='tooltip' title='$msg_date'>
                                $msg_body
                            </div><br><br><br>";}
             ...
             if(isset($_GET['u_id'])){
                 ...
                 if($u_id=="new"){
                    ...
                    <form action="">
                        ...
                        <textarea disabled class="form-control" placeholder="Enter your message" id="" cols="30" rows="10"></textarea>
                        <input type="submit" value="Send" class="btn btn-default" disabled></form><br><br>
                    </form><br><br>
                    ';
                 }
                 else{
                     echo'
                        <form action="" method="POST">
                            <center><h3>Select Someone to start conversation</h3></center>
                            <textarea name="msg_box" id="message_textarea" class="form-control" placeholder="Enter your message" id="" cols="30" rows="10"></textarea>
                            <input type="submit" value="Send" id="btn-msg" name="send_msg"></form><br><br>
                        </form><br><br>';
                 }
             }
        ?>
        <?php
            if(isset($_POST['send_msg'])){
                ...
                if($msg==""){
                    ...
                    echo"<h4 style='color:red;text-align; center;'>Message is to long use only 37 characters</h4>";
                }else{
